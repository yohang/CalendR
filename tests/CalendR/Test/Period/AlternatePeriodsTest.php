...
class AlternatePeriodsTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $year = new \CalendR\Period\Year(new \DateTime('2013-01-01'), $this->classes);
    ...
    {
        $month = new \CalendR\Period\Month(new \DateTime('2013-01-01'), $this->classes);
    ...
    {
        $week = new \CalendR\Period\Week(new \DateTime('2013W01'), $this->classes);
        foreach ($week as $day) {
